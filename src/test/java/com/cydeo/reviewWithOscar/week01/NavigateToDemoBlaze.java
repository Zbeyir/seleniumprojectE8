...
public class NavigateToDemoBlaze {
    ...
    public static void main(String[] args) {
        ...
        // Analogy (Metaphor): Taxi Driver Example
        // taxi car: browser-Chrome, taxiDriver: Selenium Web-driver- who can drive this particular car
...
// bu yukaridaki ve assagidaki ayni vazifeyi görüyor ufak bir farkla ama genelde yukaridakini kullaniyoruz
