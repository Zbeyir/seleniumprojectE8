...
public class T2_getText_getAttribute {
    ...
    public static void main(String[] args) {
        ...
        /*
        neden en son .contain method u kullandik anladin mi?
        actualHrefAttributeValue = https://login1.nextbasecrm.com/?forgot_password=yes
        cünkü su yukaridaki kocam uzun yazinin icinden bize lazim olan
        forgot_password=yes
